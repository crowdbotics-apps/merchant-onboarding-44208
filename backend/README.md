...
## Project Structure
    ...
    ├── merchant_onboarding_44208  # Django project configurations
...
1. Clone this repo and `cd merchant_onboarding_44208`
...
2. Clone this repo and `cd merchant_onboarding_44208`
