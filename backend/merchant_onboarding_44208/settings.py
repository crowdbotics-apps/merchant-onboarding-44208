"""
Django settings for merchant_onboarding_44208 project.
...
ROOT_URLCONF = 'merchant_onboarding_44208.urls'
...
WSGI_APPLICATION = 'merchant_onboarding_44208.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "merchant_onboarding_44208 API",
    "DESCRIPTION": "API documentation for merchant_onboarding_44208 App",
    "VERSION": "v1",
}
